...
public class CreateTable{
    public static final String CREAT_GUESTE = "CREATE TABLE guests " +
            "(ID SERIAL PRIMARY KEY," +
            " FIRST_NAME VARCHAR(50), " +
            " LAST_NAME VARCHAR(50), " +
            " MIDDLE_NAME VARCHAR(50))";
    
    public static final String CREAT_ROOMCLASS ="CREATE TABLE room_classes " +
    ...
    public static void executeSQLs() {
        executeSQL(CREAT_GUESTE);
        executeSQL(CREAT_ROOMCLASS);
