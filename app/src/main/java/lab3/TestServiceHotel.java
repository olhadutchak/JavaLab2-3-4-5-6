...
public class TestServiceHotel {
    ...
    public static void main(String[] args) {
        ...
        HotelServiswithoutStream hotelService = new HotelServiswithoutStream(reservations);
        ...
        System.out.println("Active Reservations for Date " + currentDate + ":");
    ...
    System.out.println("Free rooms of type " + roomTypeToSearch + " for date " + currentDate + ":");
    ...
    int targetBedCount = 4; 
        ...
        System.out.println("Free rooms with " + targetBedCount + " beds on " + currentDate + ":");
